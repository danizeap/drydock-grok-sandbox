#!/usr/bin/env python3
"""Choreography wrapper around the kernel overlays.

kernel/brief_engine.py --record-verify is completeness, not provenance (case 5b).
...
Other modes are delegated unchanged to kernel/brief_engine.py.
"""
...
KERNEL = ROOT / "kernel" / "brief_engine.py"
