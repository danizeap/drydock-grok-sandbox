...
runs. Do not call kernel/brief_complete.py --record-verify directly; kernel/brief.py and scripts/brief.py refuse the bare form.
...
BRIEF = ROOT / "kernel" / "brief_complete.py"
